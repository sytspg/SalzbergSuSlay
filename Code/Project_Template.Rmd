...
The dataset describes household income and population for all 100 counties in NC as of . Each county has its own row and is associated with several climate change indicators, such as flood hazard area. and max heat index. Each indicator has its own column for a total of 14 columns.  
