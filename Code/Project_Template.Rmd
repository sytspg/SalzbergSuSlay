...
Each indicator has its own column for a total of 14 columns. Most of the data was obtained from the NCData Portal (https://ncdataportal.org/), a platform that gathers social and enviromental data related to North Carolina from multiple sources (e.g., CDC, Census, etc.).
...
```{r Read the county data into an sf dataframe, plot.height= 12, plot.width=12}
