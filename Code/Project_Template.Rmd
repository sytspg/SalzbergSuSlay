...
JOSH: Explain what each indices mean, and why we would prefer to use "below average walkability" in the regression analysis (talk about data normality and the actual meaning of each index), with reference to the plots.
