...
We can see that the difference in population between the smallest and largest count is about a factor of 1,000. We can assume the distribution of population count is right skewed because the mean is larger than the median. The graph, figure 1 below, provides a visual.
...
Reassuringly, we see that approximately three quarters of counties in North Carolina have below 10% of their population living within Flood Hazard Areas. However, one county's population lives approximately 94.5% in Flood Hazard Areas.
